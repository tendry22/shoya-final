...
const ConfirmDepot = ({ route }) => {
  ...
  const splitAddress = (address) => {
    ...
    for (let i = 0; i < address.length; i += 20) {
      addressSegments.push(address.substring(i, i + 20));
    }
  ...
  const handleSubmit = async (newMontant, newAddress) => {
    try {
      if (validity) {
        ...
        if (isNaN(frais)) {
          ToastAndroid.show(
            "Attendez que le frais se recharge",
            ToastAndroid.SHORT
          );
        }
        if (jwt_token) {
    ...
    >
      ...
      <View style={styles.container}>
        ...
        <View style={styles.box}>
          ...
          >
            <Text style={styles.labelTxt}>Adresse</Text>
            <View>
              {splitAddress(address).map((segment, index) => (
                <Text key={index} style={styles.valueTxt}>
                  {segment}
                </Text>
              ))}
            </View>
          ...
          >
            <Text style={styles.labelTxt}>Réseau</Text>
            <Text style={styles.valueTxt}>{diminutif}</Text>
          </View>
          <View
            style={{
              flexDirection: "row",
          ...
          >
            <Text style={styles.labelTxt}>Actif</Text>
            <Text style={styles.valueTxt}>USDT</Text>
          </View>
          <View
            style={{
              flexDirection: "row",
          ...
          >
            <Text style={styles.labelTxt}>Montant</Text>
            <Text style={styles.valueTxt}>{montant} USDT</Text>
          </View>
          <View
            style={{
              flexDirection: "row",
          ...
          >
            <Text style={styles.labelTxt}>Frais de réseau</Text>
            <Text style={styles.valueTxt}>{frais}</Text>
          </View>
          <View
            style={{
              flexDirection: "row",
          ...
          >
            <Text style={styles.labelTxt}>Montant total en Ariary</Text>
